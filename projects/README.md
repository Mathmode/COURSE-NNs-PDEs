...
GitHub repository: [Improving initialization](https://github.com/emmt1998/Improving_initialization) 
...
GitHub repository: [Multi-level PINNs](https://github.com/MisterMarkus/PINNs/invitations)
